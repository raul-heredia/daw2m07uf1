...
<body>
	...
	echo "IVA: $iva%<br>";
	$pvp = preu_venda_public($preu, $iva); //Crida a preu_venda_public que retorna un valor i treballa amb paràmetres
	echo "Preu de venda al públic: $pvp €</br>";
	$pvp = pvpDescompte($desc, $preu, $iva); //Crida a pvpDescompte que retorna un valor i treballa amb paràmetres
